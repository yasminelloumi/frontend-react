...
const Body = () => {
    const handleNavigation = (path) => {
        console.log(`Navigation vers : ${path}`); // Remplacez par la logique de navigation réelle
    };

    return (
        <div className="container vh-100 d-flex flex-column justify-content-center align-items-center bg-light">
            <h1 className="mb-4 text-center">Bienvenue sur notre plateforme E-Santé</h1>
            <p className="mb-4 text-center">Choisissez une section pour continuer :</p>
                ...
                <div className="col">
                    <Card className="h-100 shadow-sm">
                        ...
                        <Card.Body>
                            ...
                            <Card.Text>
                                Accédez à votre espace personnel et gérez vos informations médicales.
                            </Card.Text>
                            <Button
                                variant="primary"
